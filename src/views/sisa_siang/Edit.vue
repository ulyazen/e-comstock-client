      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <router-link
            ...
            class="breadcrumb-item"
          >
            Data Sisa Makanan Siang</router-link
          >
        </li>
        <li class="breadcrumb-item active" aria-current="page">
          Edit Data Sisa Makanan Siang
        </li>
      </ol>
    </nav>
    <div class="card">
      <div class="card-header">Buat File Baru Sisa Makanan Siang</div>
      <div class="card-body">
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      axios
        .get(`/api/sisa/siang/${route.params.id}`, {
          headers: {
    ...
    function update() {
      axios.get("/sanctum/csrf-cookie").then(() => {
        axios
          .put(`api/sisa/siang/${route.params.id}`, pengisian, {
            headers: {
              Authorization: "Bearer " + token,
            },
          })
